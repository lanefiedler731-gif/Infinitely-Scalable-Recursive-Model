...
def export():
    ...
    for key, value in state_dict.items():
        ...
        if key.startswith("layers."):
            ...
            parts = key.split(".")
            idx = parts[1]
            module = parts[2] # attention or feed_forward or attention_norm or ffn_norm
            ...
            continue # Skip buffers, HF recomputes them
        ...
        if new_key in hf_model.state_dict():
            ...
            if value.shape != target_shape:
                 ...
                 # Logic to transpose if needed (e.g. Conv1D vs Linear), but Linear should match Linear
                 pass
...
if __name__ == "__main__":
    from train import TrainingConfig # Ensure class is available for pickle load
    export()
