...
class Trainer:
    ...
    def train_continued(
        ...
        self.config.compile_enabled = False
        model = self.create_model(vocab_size)
...
"""
    ...
    parser.add_argument('--pretrain-checkpoint', type=str, default=None,
                        help='Path to pretrained model checkpoint for instruction tuning')
    ...
    if args.pretrain:
        ...
        trainer.train(pretrain_checkpoint=args.pretrain_checkpoint)
    else:
